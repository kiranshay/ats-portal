...
function PortalTrackingTab({student, submissions}){
  // Session 18C v4: replace the simplified table view with the full
  // tutor-side ScoreHistoryPanel in readOnly mode. Same domain cards,
  // same charts, same TimelineLegend below every chart. Per Aidan:
  // "you should be replicating the score views that we have on tutors
  // side, not some BS like what is seen here."
  //
  // readOnly hides: quick-add forms, manual entry log table, the
  // WellEd report upload card. Student sees identical visualizations
  // but can't edit data. This makes the student dashboard a true
  // mirror of what their tutor sees on the Score History tab.
  return (
    <ScoreHistoryPanel
      p={student}
      readOnly={true}
      // unused in readOnly mode but kept for prop-shape stability
...
// Kept for reference / not currently rendered. The old portal tracking
// tab used this simpler view; we superseded it with ScoreHistoryPanel.
