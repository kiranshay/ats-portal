  ...
  const downloadPdf=async()=>{
    ...
    try{
      ...
      await new Promise((resolve,reject)=>{
        ...
        img.src="https://www.affordabletutoringsolutions.org/__static/jdj5jdewjge5r21lmvdyu0vwztrzwdzy/ATS-Horiz-Logo(2)";
    ...
    }catch(e){console.log("Logo fetch skipped:",e);}
    ...
    if(logoData){
      try{doc.addImage(logoData,"PNG",margin,12,160,48);}catch(e){
