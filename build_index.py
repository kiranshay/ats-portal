...
<!-- Session 18C v34: PIN React to an exact version. "react@18" floats to
     the latest 18.x on unpkg; an unattended CDN bump is exactly what took
     the whole site down via Babel. Exact pins make the portal reproducible
     and immune to surprise upstream changes. -->
