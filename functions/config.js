...
//   DEV_TEST_CLASS_ID         — pinned test class for PSM posts when
//                               WISE_WRITE_ENABLED is false. Session 16 addition.
//   DEV_TEST_SECTION_ID       — pinned test section (PSMs module) for PSM posts
//                               when WISE_WRITE_ENABLED is false. Session 16.
...
const DEV_TEST_SECTION_ID      = defineString("DEV_TEST_SECTION_ID", { default: "" });
